...
function set_class( ply )
	...
	class:MakePopup()
	if ply:Team() == 2 or ( ( ply:Team() > 7 ) and ( ply:Team() < 13 ) ) then
		...
		if teams[ply:Team()].base == 2 and ply:Team() != 8 then
		...
		if tonumber( ply:GetNWInt( "playerLevel" ) ) >= 5 then
			if teams[ply:Team()].base == 2 and ply:Team() != 9 then
		...
		if tonumber( ply:GetNWInt( "playerLevel" ) ) >= 9 then
			if teams[ply:Team()].base == 2 and ply:Team() != 10 then
		...
		if tonumber( ply:GetNWInt( "playerLevel" ) ) >= 18 then
			if teams[ply:Team()].base == 2 and ply:Team() != 11 then
		...
		if ply:IsAdmin() or ply:IsSuperAdmin() or ply:IsUserGroup("donator") or ply:IsUserGroup("owner") then
			if teams[ply:Team()].base == 2 and ply:Team() != 12 then
		...
		if teams[ply:Team()].base == 1 and ply:Team() != 3 then
			class1.DoClick = function()
		...
		if tonumber( ply:GetNWInt( "playerLevel" ) ) >= 5 then
			if teams[ply:Team()].base == 1 and ply:Team() != 4 then
				class2.DoClick = function()
		...
		if tonumber( ply:GetNWInt( "playerLevel" ) ) >= 9 then
			if teams[ply:Team()].base == 1 and ply:Team() != 5 then
				class3.DoClick = function()
		...
		if tonumber( ply:GetNWInt( "playerLevel" ) ) >= 18 then
			if teams[ply:Team()].base == 1 and ply:Team() != 6 then
				class4.DoClick = function()
		...
		if ply:IsAdmin() or ply:IsSuperAdmin() or ply:IsUserGroup("donator") or ply:IsUserGroup("owner") then
			if teams[ply:Team()].base == 1 and ply:Team() != 7 then
				class5.DoClick = function()
